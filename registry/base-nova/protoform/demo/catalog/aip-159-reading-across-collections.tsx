...
export function Aip159ReadingAcrossCollectionsDemo() {
  const [submittedValue, setSubmittedValue] = useState<string>();
  const { defaultValues, schema } = getDemoSchema("list-books");
...
export default Aip159ReadingAcrossCollectionsDemo;
