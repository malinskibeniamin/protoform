...
export function Aip128DeclarativeFriendlyInterfacesDemo() {
  const [submittedValue, setSubmittedValue] = useState<string>();
  const { defaultValues, schema } = getDemoSchema("create-book");
...
export default Aip128DeclarativeFriendlyInterfacesDemo;
