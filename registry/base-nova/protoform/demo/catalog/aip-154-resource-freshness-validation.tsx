...
export function Aip154ResourceFreshnessValidationDemo() {
  const [submittedValue, setSubmittedValue] = useState<string>();
  const { defaultValues, schema } = getDemoSchema("delete-book");
...
export default Aip154ResourceFreshnessValidationDemo;
