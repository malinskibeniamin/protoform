...
export interface ShadcnComponentCoverage {
  autoFormRole: string;
  component: string;
...
export interface ShadcnAutoFormControl {
  bestFor: string;
  control: string;
  protoAnnotation: string;
...
export const shadcnComponentCoverage: ShadcnComponentCoverage[] = [
  ...
  {
    autoFormRole: "Date and timestamp picker surface",
    component: "Calendar",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_DATE / CONTROL_TYPE_TIMESTAMP",
  },
  ...
  {
    autoFormRole: "Searchable selects",
    component: "Combobox",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_COMBOBOX",
  },
  ...
  {
    autoFormRole: "Text, email, URL, password, and numeric scalars",
    component: "Input",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_TEXT / EMAIL / URL / PASSWORD / CURRENCY",
  },
  {
    autoFormRole: "Currency, date, suffix, and prefix affordances",
    component: "InputGroup",
    kind: "field-composition",
  },
  {
    autoFormRole: "Struct, Value, Any, and raw payload fields",
    component: "JsonField",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_JSON",
  },
  {
    autoFormRole: "Map and repeated key/value fields",
  ...
  {
    autoFormRole: "Repeated enum/string choices",
  ...
  {
    autoFormRole: "Enum fields where every option should stay visible",
    component: "RadioGroup",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_RADIO_GROUP",
  },
  {
    autoFormRole: "Single enum/provider-backed values",
    component: "Select",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_SELECT",
  },
  ...
  {
    autoFormRole: "Bounded numeric ranges",
    component: "Slider",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_SLIDER",
  },
  ...
  {
    autoFormRole: "Feature flags and boolean toggles",
    component: "Switch",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_SWITCH",
  },
  ...
  {
    autoFormRole: "Long string fields",
    component: "Textarea",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_TEXTAREA",
  },
  {
    autoFormRole: "Compact boolean choices",
    component: "Toggle",
    kind: "field-control",
    protoAnnotation: "CONTROL_TYPE_TOGGLE",
  },
