...
export const UiRuleFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(UiRuleSchema, options),
...
export const MessageUiOptionsFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(MessageUiOptionsSchema, options),
...
export const FieldUiOptionsFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(FieldUiOptionsSchema, options),
...
export const OneofUiOptionsFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(OneofUiOptionsSchema, options),
