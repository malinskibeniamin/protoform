...
export const AutoFormExampleFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(AutoFormExampleSchema, options),
...
export const AutoFormUiMetadataExampleFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(AutoFormUiMetadataExampleSchema, options),
...
export const AddressFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(AddressSchema, options),
...
export const GeoPointFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(GeoPointSchema, options),
...
export const ProfileSettingsFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(ProfileSettingsSchema, options),
...
export const NestedSettingFormBinding = {
  ...
  createFormSchema: (options?: Parameters<typeof createProtoFormSchema>[1]) => createProtoFormSchema(NestedSettingSchema, options),
