...
export const demoHubCategories = [
  "aip",
  "protobuf",
  "protovalidate",
  "cel",
...
export const demoHubs = [
  {
    category: "aip",
    description:
      "Focused live examples for every form-applicable Google API Improvement Proposal.",
  ...
  },
  {
    category: "protobuf",
    description:
      "Live examples for protobuf fields, presence, collections, maps, oneofs, and well-known types.",
  ...
  },
  {
    ...
    description:
      "Live examples for Protovalidate rules, formats, collections, and complete violation reporting.",
  ...
  },
  {
    category: "cel",
    description:
      "Live examples for CEL expressions, protobuf values, evaluation safety, and UI rules.",
    slug: "cel-examples",
    title: "CEL examples",
  },
  {
    category: "production",
    description:
      "Live examples for form-library interoperability, accessibility, resilience, and production behavior.",
...
export function demoHubCategoryFor(category: DemoCategory): DemoHubCategory {
  switch (category) {
    ...
    default: {
      ...
      throw new Error(
        `Unsupported demo category: ${String(unsupportedCategory)}`
      );
    }
  }
}
...
const demosByHub = new Map(
  demoHubCategories.map((category) => [
    category,
    demoCatalog.filter(
      (demo) => demoHubCategoryFor(demo.category) === category
    ),
  ])
);

export function demosForHub(
  category: DemoHubCategory
): readonly DemoCatalogEntry[] {
