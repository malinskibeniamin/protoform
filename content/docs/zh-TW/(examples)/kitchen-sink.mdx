---
title: 廚房水槽
description: "在單一即時表單中，全面演練 Protoform 的 protobuf、Protovalidate、CEL 與步驟器功能。瞭解適用情境、關鍵行為、實作重點、驗證方法與實際整合細節。"
---
**第 8 級，共 8 級**
...
[CEL 語言規格](https://github.com/cel-expr/cel-spec)，以了解底層契約。
