---
title: LLM 遷移手冊
description: "為程式設計代理提供具型別的 Protoform 情境，透過靜態文件尋找聚焦的表單範例，並安全地審查產生的 protobuf 遷移。本指南進一步說明如何在 Protoform 中實際套用此功能，並涵蓋契約設計、表單產生、欄位驗證、錯誤處理、遷移策略、無障礙體驗、測試方法與正式環境整合。"
---
