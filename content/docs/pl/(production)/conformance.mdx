...
description: "Wykonywalne kontrakty dotyczące parsowania deskryptorów, walidacji, ścieżek formularzy i konwersji. Poznaj praktyczne użycie w Protoform."
---
...
niewielki publiczny interfejs. Protoform obecnie wykonuje ten model w ramach procesu za pomocą Rstest, ponieważ
...
Podczas tworzenia pojedynczego kontraktu użyj filtra nazw Rstest:
