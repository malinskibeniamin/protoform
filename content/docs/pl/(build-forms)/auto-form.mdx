...
description: "Generowanie dostępnych formularzy shadcn na podstawie metadanych schematu protobuf. Poznaj praktyczne użycie w Protoform."
---
...
Domyślny element rejestru `protoform-react` używa React Hook Form. Zainstaluj `auto-form-tanstack` i zaimportuj
