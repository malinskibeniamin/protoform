...
TanStack Form v2 支持是一条独立的可选路径，不会取代上述稳定版 v1 项目。registry 目前通过 package alias 固定使用 `2.0.0-alpha.0`，因此可以在一个应用中评估两个版本。采用前，请查看上游的 [v2 公告](https://tanstack.com/blog/announcing-tanstack-form-v2-alpha)和[迁移指南](https://tanstack.com/form/alpha/docs/migrate-from-v1)。
