---
title: LLM 迁移手册
description: "为编码智能体提供类型化的 Protoform 上下文，通过静态文档查找针对性的表单示例，并安全审查生成的 protobuf 迁移。本指南进一步说明如何在 Protoform 中实际应用此功能，并涵盖契约设计、表单生成、字段验证、错误处理、迁移策略、无障碍体验、测试方法与生产环境集成。"
---
