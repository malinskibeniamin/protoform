...
description: "Move Protobuf-ES v1 generated classes to the v2 schema-first TypeScript API used by Protoform. See the practical Protoform implementation guide."
---
...
The [official Protobuf-ES migration section](https://protobufes.com/reference/migrating-from-v1/)
