...
describe("CEL guarded runtime conformance", () => {
  test("propagates partial unknown attributes separately from evaluation errors", () => {
  ...
  test("merges unknown sets and preserves logical short circuit", () => {
  ...
  test("enforces a configurable execution budget and fails safely", () => {
