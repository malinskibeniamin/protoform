...
export default defineConfig({
    ...
    overrides: [
      {
        ...
        files: ["registry/base-nova/protoform/components/**"],
        rules: ["react-doctor/no-barrel-import"],
      },
      {
        // This generated annotation table targets the package's public entrypoint.
        files: ["registry/base-nova/protoform/lib/protobuf-provider/auto-form-example-annotations.ts"],
        rules: ["react-doctor/no-barrel-import"],
      },
      {
      ...
      {
        // Registry components are intentionally colocated into atomic install units.
        files: ["registry/base-nova/protoform/components/**"],
        rules: ["react-doctor/no-multi-comp"],
      },
      {
        // Public primitives must forward consumer-owned native props. Listing every DOM prop
        // would narrow their declared React component contracts.
        files: ["registry/base-nova/protoform/components/**"],
      ...
      {
        // The Base UI compatibility Slot is an installable component primitive: it must
        // inspect and clone its child to merge refs, handlers, and native consumer props.
        files: ["registry/base-nova/protoform/lib/base-ui-compat/index.tsx"],
        rules: [
      ...
      {
        // Raw sources are lazy virtual modules. Their default method is named, but Doctor
        // cannot resolve that display name through Vite's dynamic import factory.
  ...
  rules: {
    ...
    "react-doctor/base-ui-field-requires-label": "error",
    "react-doctor/base-ui-tabs-tab-requires-list": "error",
    "react-doctor/circular-dependency": "error",
    "react-doctor/duplicate-jsx-subtree": "error",
    ...
    "react-doctor/react-aria-dialog-requires-heading": "error",
    "react-doctor/shadcn-command-item-state-variant-requires-value": "error",
    "react-doctor/shadcn-dialog-content-requires-title": "error",
    "react-doctor/shadcn-form-item-requires-label": "error",
    "react-doctor/shadcn-icon-button-requires-label": "error",
    "react-doctor/shadcn-input-group-no-raw-controls": "error",
    "react-doctor/tanstack-form-on-submit-requires-prevent-default": "error",
    "react-doctor/tanstack-table-no-unstable-data-or-columns": "error",
    "react-doctor/tanstack-virtual-measure-element-requires-data-index": "error",
    "react-doctor/unused-dependency": "error",
    "react-doctor/unused-dev-dependency": "error",
    "react-doctor/unused-export": "error",
    "react-doctor/unused-file": "error",
    "react-doctor/unused-type": "error",
